...
% Skips videos whose _tracking_results.mat already exists.
% Can be called standalone (no args) or from run_pipeline.m.
%
% Categories (mutually exclusive, pause takes priority):
%   Pause    : speed < 0.3 px/frame
%   Crawling : blob boundary crosses the user-drawn open polyline  (& ~Pause)
